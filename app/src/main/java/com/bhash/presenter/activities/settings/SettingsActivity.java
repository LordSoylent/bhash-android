...
import com.bhash.R;
import com.bhash.presenter.activities.CurrencySettingsActivity;
import com.bhash.presenter.activities.UpdatePinActivity;
import com.bhash.presenter.activities.util.BRActivity;
import com.bhash.presenter.entities.BRSettingsItem;
...
import static com.bhash.R.layout.settings_list_item;
import static com.bhash.R.layout.settings_list_section;
...
public class SettingsActivity extends BRActivity {
    ...
    private void populateItems() {
        ...
        items.add(new BRSettingsItem(getString(R.string.Settings_review), "", new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent appStoreIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("market://details?id=" + "com.bhash"));
                    appStoreIntent.setPackage("com.android.vending");

                    startActivity(appStoreIntent);
                } catch (android.content.ActivityNotFoundException exception) {
                    startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://play.google.com/store/apps/details?id=" + "com.bhash")));
                }
                overridePendingTransition(R.anim.enter_from_right, R.anim.exit_to_left);
            }
        }, false));
