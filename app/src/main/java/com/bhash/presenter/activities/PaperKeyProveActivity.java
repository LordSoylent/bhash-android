...
import com.bhash.tools.security.SmartValidator;
import com.bhash.tools.util.Utils;
import com.bhash.tools.util.Bip39Reader;
...
//        wordEditSecond.setOnFocusChangeListener(new FocusListener());
        ...
        if (wordArray.length == 12 && cleanPhrase.charAt(cleanPhrase.length() - 1) == '\0') {
            ...
            BRReportsManager.reportBug(new IllegalArgumentException("Paper Key error, please contact support at bhash.com"), false);
        } else {
